                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    <td>
                                        ...
                                        <a href='master_ruangan.php?id={$row['id']}&edit=1' class='btn btn-primary mr-2'>Change</a>";
                                    if ($row['nonaktif']== 0){
                                        echo "<a href='crud/hapus.php?id={$row['id']}&tabel=master_ruangan&master=master_ruangan.php' class='btn btn-success'>Restore</a>";
                                    } else {
                                        echo "<a href='crud/hapus.php?id={$row['id']}&tabel=master_ruangan&master=master_ruangan.php' class='btn btn-danger'>Remove</a>";
                                    }
                                    echo "</div>
                                    </td>
                                    </tr>";
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                        <?php
                            ...
                            if ($edit) {
                                $id = $_GET['id'];
                                $sql = "SELECT * FROM master_ruangan WHERE id=$id";
                                $result = $conn->query($sql);
                        ...
                        ?>
                    <form id="main-form" method="post" action="<?php echo $edit == 0 ? 'crud/tambah.php?tabel=master_ruangan&kolom=ruangan&master=master_ruangan.php' : 'crud/edit.php?id=' . htmlspecialchars($row['id']) . '&tabel=master_ruangan&kolom=ruangan&master=master_ruangan.php'; ?>">

                        <div class="form-group">
                            <label for="ruangan">Ruangan</label>
                            <input type="text" class="form-control" id="ruangan" name="isi" required
                            <?php echo $edit > 0 ? 'value="' . htmlspecialchars($row['ruangan']) . '"' : 'placeholder=""'; ?>>
                        </div>
